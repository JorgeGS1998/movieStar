...
<body>
    <header>
        <nav id="main-navbar" class="navbar navbar-expand-lg">
            ...
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbar" aria-controls="navbar" aria-expanded="false" arial-label="toggle navigation">
    ...
    <div class="msg-container">
      <p class="msg <?= $flassMessage["type"] ?>"><?= $flasMessage["msg"] ?></p>
    </div>
    <?php endif; ?>
